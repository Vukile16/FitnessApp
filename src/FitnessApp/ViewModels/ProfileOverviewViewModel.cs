...
namespace FitnessApp.ViewModels
{
    public class ProfileOverviewViewModel : ViewModelBase
    {
        ...
        public List<string> Week1 { get; set; }
        public List<string> Week2 { get; set; }
        public List<string> Week3 { get; set; }
        public List<string> Week4 { get; set; }
        public List<string> Week5 { get; set; }
